...
export default function BusinessInfoPage() {
  ...
  return (
    <div className="flex min-h-screen bg-black">
      ...
      <div className="w-1/2 min-h-screen flex flex-col justify-center items-center px-10">
        <h2 className="text-3xl font-semibold text-white mb-6 text-center">
          Опиши бизнеса си в 0-500 думи
        </h2>
        <div className="relative w-full max-w-lg">
          <textarea
            className="w-full h-52 p-4 text-white bg-black/30 transition-all placeholder-gray-300"
        ...
        <button
          ...
          className={`mt-6 w-full max-w-lg py-3 text-lg font-medium rounded-lg transition-all duration-300 ${
            wordCount > 500
              ? "bg-gray-700 text-gray-400 cursor-not-allowed"
              : "bg-black bg-opacity-80 cursor-pointer text-white hover:bg-opacity-100"
          }`}
      ...
      <div className="w-1/2 min-h-screen flex flex-col justify-center px-16 bg-gradient-to-br from-green-400 to-yellow-400 text-white">
        <div className="bg-black rounded-lg max-w-lg w-full p-8 shadow-lg">
