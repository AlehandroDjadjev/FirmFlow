  ...
  useEffect(() => {
    async function fetchChatHistory() {
      try {
        ...
        const res = await fetch(`http://localhost:8000/api/LLM/interactions/${firmId}/`, {
          headers: {
      ...
      <div className="w-3/4 bg-[#111] p-10 text-white flex flex-col">
        ...
        <div className="flex mb-4">
          ...
          <button
            ...
            className={`px-6 py-4 rounded-r-lg transition-colors duration-300 ${loading || !inputMessage.trim()
