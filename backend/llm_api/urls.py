...
from .views import initialize_firm, submit_prompt, list_firms, get_full_chat_history, edit_main_document
...
urlpatterns = [
    ...
    path('interactions/<int:firm_id>/',
         get_full_chat_history, name='get_firm_interactions'),
    path('edit-main/<int:firm_id>/', edit_main_document,
         name='get_firm_interactions'),
