...
ALLOWED_HOSTS = ['localhost','127.0.0.1','bezzloba.com','www.bezzloba.com']
CORS_ALLOWED_ORIGINS = ['http://localhost:3000','http://localhost:8000','https://bezzloba.com','https://www.bezzloba.com']
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'firmflow_db'),
        'USER': os.getenv('DB_USER', 'firmflow_user'),
